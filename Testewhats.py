...
class zapbot:
    ...
    # To Solve DeprecationWarning: executable_path has been deprecated, 
    # please pass in a Service object Error Here executable_path is 
    # deprecated you have to use an instance of the Service() class as follows
